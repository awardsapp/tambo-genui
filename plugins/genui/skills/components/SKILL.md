---
name: components
description: Creates and registers Genui components - generative (AI creates on-demand) and interactable (pre-placed, AI updates). Use when defining components, working with GenuiComponent, withGenuiInteractable, propsSchema, or registering components for AI to render or update.
---
...
```tsx
import { GenuiProvider, GenuiComponent } from "@workspace/react";
import { z } from "zod";
...
<GenuiProvider apiKey={apiKey} components={components}>
  <App />
</GenuiProvider>;
```
