...
import { useGenuiVoice } from "./use-genui-voice";
...
jest.mock("../providers/genui-client-provider", () => ({
  ...jest.requireActual("../providers/genui-client-provider"),
...
describe("useGenuiVoice", () => {
  ...
  beforeEach(() => {
    ...
    jest
      .mocked(useGenuiClient)
      .mockReturnValue(mockClient as unknown as GenuiAI);
  ...
  describe("Initial State", () => {
    it("should initialize with idle state and no transcript", () => {
      const { result } = renderHook(() => useGenuiVoice(), {
  ...
  describe("Recording Flow", () => {
    ...
    it("should reset transcript when starting a new recording", async () => {
      ...
      const { result, rerender } = renderHook(() => useGenuiVoice(), {
        wrapper: createWrapper(),
      });
