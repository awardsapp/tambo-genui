...
/**
 * Test suite for GenuiContextHelpersProvider (simplified API, registry-backed)
 *
 * The simplified API:
 ...
 */
describe("GenuiContextHelpersProvider", () => {
  ...
  describe("useGenuiContextHelpers", () => {
    /**
    ...
    it("should handle errors in context helper functions gracefully", async () => {
      ...
      const withBadHelper = ({ children }: { children: React.ReactNode }) => (
        <GenuiContextHelpersProvider contextHelpers={{ badHelper }}>
          {children}
        </GenuiContextHelpersProvider>
      );
...
describe("Custom Context Helpers via contextHelpers config", () => {
  ...
  it("should handle dynamic addition of custom helpers", async () => {
    const { result } = renderHook(() => useGenuiContextHelpers(), {
      wrapper: ({ children }) => (
        <GenuiContextHelpersProvider contextHelpers={{}}>
          {children}
        </GenuiContextHelpersProvider>
      ),
    });
