...
export interface GenuiContextHelpersProviderProps {
  /**
...
export interface GenuiContextHelpersContextProps {
...
const GenuiContextHelpersContext =
  createContext<GenuiContextHelpersContextProps | null>(null);
 ...
 * @param props - The props for the GenuiContextHelpersProvider.
 * @param props.contextHelpers - A dictionary of context helper functions keyed by context name.
 * @param props.children - The children to render.
 * @returns The provider that exposes context helper APIs via useGenuiContextHelpers.
 */
export const GenuiContextHelpersProvider: React.FC<
  PropsWithChildren<GenuiContextHelpersProviderProps>
> = ({ children, contextHelpers }) => {
  ...
  return (
    <GenuiContextHelpersContext.Provider value={value}>
      {children}
    </GenuiContextHelpersContext.Provider>
  );
};
 ...
 * called outside of a `GenuiContextHelpersProvider`, it returns a fallback
 ...
 */
export const useGenuiContextHelpers = () => {
  const context = useContext(GenuiContextHelpersContext);
  ...
  return {
    getAdditionalContext: async () => {
      throw new Error(
        "useGenuiContextHelpers must be used within a GenuiContextHelpersProvider",
      );
    },
    getContextHelpers: () => {
      throw new Error(
  ...
  } as GenuiContextHelpersContextProps;
};
