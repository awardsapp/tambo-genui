...
} from "./genui-context-attachment-provider";
...
beforeEach(() => {
  jest.clearAllMocks();
  (useGenuiContextHelpers as jest.Mock).mockReturnValue({
...
/**
 * Test suite for GenuiContextAttachmentProvider
 *
 ...
 */
describe("GenuiContextAttachmentProvider", () => {
  /**
   * Base wrapper with GenuiContextAttachmentProvider
  ...
  describe("Hook Access", () => {
    ...
    it("should provide context attachment API functions", () => {
      const { result } = renderHook(() => useGenuiContextAttachment(), {
    ...
    it("should throw error when used outside provider", () => {
      ...
      expect(() => {
        renderHook(() => useGenuiContextAttachment());
      }).toThrow(
