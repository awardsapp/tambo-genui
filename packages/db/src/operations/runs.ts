...
/**
 * Mark a run as cancelled and complete it.
 * Sets status to IDLE so the run is no longer considered active.
 */
 ...
 * 3. Therefore the latest assistant message IS the one being generated by
