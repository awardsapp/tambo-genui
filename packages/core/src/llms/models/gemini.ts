...
export const geminiModels: Partial<LlmModelConfig<GeminiModelId>> = {
  "gemini-3-pro-preview": {
    ...
    genuiDocLink:
      "https://docs.genui.co/reference/llm-providers/google#gemini-3-pro-preview",
  ...
  "gemini-2.5-pro": {
    ...
    genuiDocLink:
      "https://docs.genui.co/reference/llm-providers/google#gemini-2-5-pro",
    inputTokenLimit: 1048576,
    supportsSkills: false,
    modelSpecificParams: reasoningParameters,
  },
  "gemini-2.5-flash": {
    ...
    genuiDocLink:
      "https://docs.genui.co/reference/llm-providers/google#gemini-2-5-flash",
    inputTokenLimit: 1048576,
    supportsSkills: false,
    modelSpecificParams: reasoningParameters,
  },
  "gemini-2.0-flash": {
    ...
    genuiDocLink:
      "https://docs.genui.co/reference/llm-providers/google#gemini-2-0-flash",
    inputTokenLimit: 1048576,
    supportsSkills: false,
  },
  "gemini-2.0-flash-lite": {
    ...
    genuiDocLink:
      "https://docs.genui.co/reference/llm-providers/google#gemini-2-0-flash-lite",
    inputTokenLimit: 1048576,
    supportsSkills: false,
  },
};
