...
export const components: GenuiComponent[] = [
  {
    name: "DashboardCard",
    description:
      "A card component that directs users to the genui dashboard, whenever a user asks to go to the dashboard, use this component to redirect them to the dashboard.",
  ...
  },
  {
    name: "DiscordInvite",
    description:
      "A component that invites users to join the Genui Discord server, whenever a user asks about community, support, Discord, or getting help, use this component to invite them to Discord.",
