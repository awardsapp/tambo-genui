...
Google's Gemini models provide powerful multimodal capabilities with advanced reasoning features. Genui supports Gemini models across three generations: Gemini 3, Gemini 2.5, and Gemini 2.0.
