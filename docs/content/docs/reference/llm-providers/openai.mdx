---
title: OpenAI
description: Configure OpenAI models in Tambo including GPT-5.4, GPT-5.3, GPT-5.2, GPT-5, GPT-4.1, o3, GPT-4o, and GPT-4 Turbo families with reasoning capabilities.
---
...
In your Genui Cloud dashboard under **Settings** → **LLM Providers** → **Custom LLM Parameters**:
...
1. Navigate to your project in the Genui Cloud dashboard
