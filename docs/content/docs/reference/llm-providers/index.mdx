...
description: Understanding AI model providers and how they integrate with Genui
---

import { Card, Cards } from "fumadocs-ui/components/card";

AI models are the foundation of agent behavior in Genui. Different models excel at different tasks—some are optimized for speed, others for reasoning depth, and others for cost efficiency. Understanding the characteristics of available models helps you choose the right tool for your application's needs.
...
Genui makes it easy to switch between providers and models, letting you optimize for your specific use case.

## Available Providers

Genui integrates with five major AI providers, each with unique strengths:
...
Model providers are configured at the project level in Genui Cloud. Each project has:
...
Each model carries a status label indicating how thoroughly it has been tested with Genui:

- **Tested** - Validated on common Genui tasks; recommended for production
...
<Cards>
  ...
  <Card href="/reference/llm-providers/labels" title="Model Labels & Status">
    Understand model testing status and known behaviors with Genui
  </Card>
  <Card
    href="/reference/llm-providers/reasoning-models"
