...
Not yet validated on common Genui tasks. This model is newly released as of November 2025. Use with caution and test in your specific context.
...
Not yet validated on common Genui tasks. This model is newly released as of November 2025 with enhanced multimodal capabilities. Use with caution and test in your specific context.
...
Not yet validated on common Genui tasks. With 70B parameters, this model offers strong capabilities but may have higher latency than smaller variants.
...
- **Test thoroughly** since all models are currently [untested with Genui](#known-behaviors)
- **Monitor costs** and performance to find the right balance for your use case

## Known Behaviors

<Callout type="warning" title="Untested Models">
  All Groq Llama models are currently **Untested** in Genui. They are newly
