---
title: Overview
description: Reference for unstyled base primitives in @workspace/react-ui-base.
---

import { ExamplesDemoPreview } from "./_demos/examples-demo";

The `@workspace/react-ui-base` package exposes behavior-focused primitives. These components are intentionally unstyled and designed for composition in your own UI layer.
...
- `@workspace/react-ui-base`: behavior, state, and composition contracts.
- `@workspace/ui-registry`: styled components and block-level orchestration.
