---
title: REST API
description: OpenAPI specification for the Genui Cloud REST API
---

The Genui Cloud REST API provides programmatic access to threads, messages, and AI generation capabilities.

## OpenAPI Specification

The complete REST API is documented via an interactive OpenAPI specification available at:

**[api.genui.co/api](https://api.genui.co/api)**
...
curl -H "Authorization: Bearer YOUR_API_KEY" \
  https://api.genui.co/threads
```

Get your API key from the [Genui Cloud dashboard](https://console.genui.co).
...
- **React**: [`@workspace/react`](/reference/react-sdk) - Full-featured React SDK with hooks and providers
- **TypeScript/Node**: [`@workspace/typescript-sdk`](https://www.npmjs.com/package/@workspace/typescript-sdk) - Core TypeScript client
