...
This guide walks you through configuring LLM providers and models for your Genui project, including provider-specific settings and parameter tuning patterns.

## Step 1: Select a Provider

Genui supports multiple LLM providers:
...
Navigate to your project's LLM Configuration section in the settings of the Genui dashboard and select your provider from the dropdown.
...
3. Enter **Custom Base URL** without "chat/completions" - Genui will add this automatically. (e.g., `https://api.myai.xyz/v1` becomes `https://api.myai.xyz/v1/chat/completions`)
