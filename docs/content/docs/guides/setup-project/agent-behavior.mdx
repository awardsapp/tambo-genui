...
1. Open your project in the [Genui Cloud dashboard](https://console.genui.co)
...
- [Give Genui Extra Context](/guides/give-context) - Runtime context injection for user-specific information
