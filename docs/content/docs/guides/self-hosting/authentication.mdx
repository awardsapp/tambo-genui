...
description: Configure OAuth providers or email login for your self-hosted Genui deployment.
---

Genui supports two authentication modes for the dashboard: **OAuth** (Google and/or GitHub) and **email login** (via Resend). You must configure at least one.
