...
description: Complete reference for all Genui self-hosting environment variables.
---
...
| `POSTGRES_DB`         | No       | Database name (default: `genui`)                                                         |
...
| Variable                    | Description                       |
| --------------------------- | --------------------------------- |
| `GENUI_WHITELABEL_ORG_NAME` | Organization name displayed in UI |
| `GENUI_WHITELABEL_ORG_LOGO` | URL to organization logo          |
