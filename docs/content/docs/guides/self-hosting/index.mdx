---
title: Self-hosting Tambo
description: Deploy and run Tambo on your own infrastructure with Docker Compose or Kubernetes.
icon: Server
---
...
5. **Set `ALLOWED_LOGIN_DOMAIN`** — restrict access to your organization's email domain (or a comma-separated list of domains)
