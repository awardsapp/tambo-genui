---
title: Self-hosting Genui
description: Deploy and run Genui on your own infrastructure with Docker Compose or Kubernetes.
icon: Server
---

import LearnMore from "@/components/learn-more";

Genui Cloud is the hosted platform behind Genui AI. Self-hosting gives you full control over your data, infrastructure, and authentication.
...
Genui supports two mutually exclusive authentication modes:
