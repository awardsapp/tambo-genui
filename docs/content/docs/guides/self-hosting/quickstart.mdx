...
description: Get a self-hosted Genui deployment running locally with Docker Compose.
icon: Rocket
---

Follow these steps to go from zero to a running Genui instance on your machine using Docker Compose.
...
You now have a local Genui deployment. To take it further:
