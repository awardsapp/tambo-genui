...
```bash
VITE_GENUI_API_KEY=your_api_key_here
```
...
```bash
EXPO_PUBLIC_GENUI_API_KEY=your_api_key_here
```
...
For Expo, the registry components (DOM + Tailwind) won't work in React Native. Use `@workspace/react` hooks directly to build your native UI. See the Expo demos for complete examples: [Activity Logger](https://github.com/tambo-ai/demo-mobile-log), [Music Companion](https://github.com/tambo-ai/music-expo-demo).
