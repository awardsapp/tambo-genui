...
# Build Genui Docker Containers
# This script builds all containers for the Genui application
...
info "🔨 Building Genui Docker Containers..."
...
success \
  "✅ Build completed!" \
  "💡 To start the containers: ./scripts/cloud/genui-start.sh" 
