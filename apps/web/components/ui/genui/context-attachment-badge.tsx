 ...
 * This decouples ContextAttachmentBadgeList from the full GenuiThreadMessage type.
 */
...
export interface ContextAttachmentBadgeListProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  message?: GenuiThreadMessage | ContextAttachmentBadgeListData;
...
>(({ message, showRemoveButtons = false, className, ...props }, ref) => {
  ...
  const threadInput = useGenuiThreadInput();
