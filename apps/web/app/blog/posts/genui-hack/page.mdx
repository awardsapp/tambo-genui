---
title: "GenuiHack: For Your UI Only - $10k in Grants & Prizes"
date: "2025-08-25"
...
![GenuiHack: $10k in Grants & Prizes](/genuihack.png)

The future of generative user experiences is here, and we want you to help build it. **GenuiHack: For Your UI Only** is a focused week-long hackathon where developers, designers, and builders come together to push the boundaries of what's possible with AI-powered React frontends.

## The Mission

Genui is an AI orchestration framework for React frontends that's changing how we think about user interfaces. Instead of static components, imagine interfaces that adapt, generate, and evolve based on user needs in real-time.

For one intensive week, you'll join the Genui team to help shape this future. Whether you're contributing to the core platform or building innovative templates, there's **$10,000 in grants and prizes** waiting for exceptional work.

## Two Paths to Impact

### 🚀 Founding Contributors ($6,500+)

**Limited to 10 selected developers** who will tackle specific, high-impact issues in the Genui ecosystem.

**What You'll Get:**

- A scoped issue with attached grant (minimum $250)
- Direct collaboration with the Genui core team
...
**Open to all applicants** - your mission is to create Genui starter templates that take developers from concept to working example lightning fast.

**Your Challenge:**
Build an open-source Genui template that showcases the platform's capabilities and helps developers get started quickly.
...
Traditional UI development is hitting its limits. Users expect interfaces that understand context, adapt to their needs, and provide intelligent assistance. Genui bridges the gap between static React components and truly intelligent user experiences.
...
## What Makes Genui Special

Genui isn't just another AI tool - it's a complete orchestration framework that:
...
1. **Register:** Visit the [GenuiHack event page](https://lu.ma/e5irqmfh) and request to join
2. **Choose Your Path:** Decide whether you want to be a Founding Contributor or Founding Builder
3. **Prepare:** Familiarize yourself with the Genui documentation and examples
...
- The Genui core team who built the framework
...
Join us for GenuiHack and help build the future of generative user experiences. With $10,000 in prizes and the chance to shape a revolutionary platform, this is your opportunity to be at the forefront of the next wave of web development.

[Register now](https://lu.ma/e5irqmfh) and let's build something extraordinary together.

---

_Questions about GenuiHack? Reach out to the team or join our [discord](https://genui.co/discord). We're here to help you succeed._
