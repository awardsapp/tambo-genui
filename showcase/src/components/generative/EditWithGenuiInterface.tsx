import { EditWithGenuiButton } from "@workspace/ui-registry/components/edit-with-genui-button";
...
const ContactForm = withGenuiInteractable(ContactFormBase, {
...
export const EditWithGenuiInterface = () => {
  ...
  return (
    <div className="relative flex flex-col gap-6 p-4 md:p-8 min-h-[700px]">
      ...
      <MessageThreadCollapsible
        ...
        className="z-60"
        initialSuggestions={editWithGenuiThreadSuggestions}
      />
    </div>
  );
};
