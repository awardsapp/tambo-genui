...
import { EditWithGenuiInterface } from "@/components/generative/EditWithGenuiInterface";
import { InstallationSection } from "@/components/installation-section";

export default function EditWithGenuiButtonPage() {
  return (
    <div className="prose max-w-8xl space-y-12">
      {/* Title & Description */}
      <header className="space-y-4">
        <h1 className="text-3xl md:text-4xl font-semibold tracking-tight">
          Edit with Genui Button
        </h1>
      ...
      <section className="space-y-6">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          GenuiProvider, which sets a per-user context key (persisted in
          localStorage).
        </p>
        ...
        <div className="space-y-6">
          <ComponentCodePreview
            title="Basic Usage"
            component={<EditWithGenuiInterface />}
            code={`import { EditWithGenuiButton } from "@/components/genui/edit-with-genui-button";
...
const MyCard = withGenuiInteractable(MyCardBase, {
...
export function App() {
  return <MyCard title="Welcome" description="Edit me!" />;
            ...
            minHeight={800}
            enableFullscreen
            fullscreenTitle="Edit with Genui Button"
          />
        </div>
      </section>
      ...
      {/* Installation */}
      <section>
        <InstallationSection cliCommand="npx genui add edit-with-genui-button" />
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold">EditWithGenuiButton</h3>
